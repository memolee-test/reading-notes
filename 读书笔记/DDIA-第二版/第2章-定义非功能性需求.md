...
![[fig/ddia_0201.png|图 2-1. 社交网络的简单关系模式，用户可以相互关注。]]
...
![[fig/ddia_0202.png|图 2-2. 扇出：将新帖子传递给发布帖子的用户的每个追随者。]]
...
![[fig/ddia_0203.png|图 2-3. 随着服务的吞吐量接近其容量，由于排队，响应时间急剧增加。]]
...
![[fig/ddia_0204.png|图 2-4. 响应时间、服务时间、网络延迟和排队延迟。]]
...
![[fig/ddia_0205.png|图 2-5. 说明平均值和百分位点：100 个服务请求的响应时间样本。]]
...
![[fig/ddia_0206.png|图 2-6. 当需要几个后端调用来服务请求时，只需要一个慢的后端请求就可以减慢整个最终用户请求。]]
