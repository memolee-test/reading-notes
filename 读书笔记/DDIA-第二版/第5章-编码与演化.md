...
![[fig/ddia_0501.png|图 5-1. 当旧版本的应用程序更新之前由新版本应用程序写入的数据时，如果不小心，数据可能会丢失。]]
...
![[fig/ddia_0503.png|图 5-3. 使用 Protocol Buffers 编码的示例记录。]]
...
![[fig/ddia_0504.png|图 5-4. 使用 Avro 编码的示例记录。]]
...
![[fig/ddia_0505.png|图 5-5. 在 Protocol Buffers 中，编码和解码可以使用不同版本的模式。在 Avro 中，解码使用两个模式：写入者模式必须与用于编码的模式相同，但读取者模式可以是较旧或较新的版本。]]
...
![[fig/ddia_0506.png|图 5-6. Avro 读取器解决写入者模式和读取者模式之间的差异。]]
